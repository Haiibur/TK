...
Config::$serverKey = 'SB-Mid-server-3XqDS86A6xIG0SDj7UzWa_BY';
...
{
    if (strpos(Config::$serverKey, 'SB-Mid-server-3XqDS86A6xIG0SDj7UzWa_BY') != false) {
        echo "<code>";
        echo "<h4>Please set your server key from sandbox</h4>";
        echo "In file: " . __FILE__;
        echo "<br>";
        echo "<br>";
        echo htmlspecialchars('Config::$serverKey = \'SB-Mid-server-3XqDS86A6xIG0SDj7UzWa_BY\';');
        die();
    }
}
